...
at https://github.com/matus-chochlik/eagine-all and implements a set of utilities
for rapid development of audiovisual applications.

Cloning the repository
======================
::

 git clone https://github.com/matus-chochlik/eagine-app.git
