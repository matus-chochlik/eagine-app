/// @example app/014_voronoi/main.cpp
///
...
example_voronoi::example_voronoi(execution_context& ec, video_context& vc)
  ...
  , _video{vc} {
    ...
    ec.connect_inputs()
      .connect_input(
        {"Motion", "Dampening"},
        make_callable_ref<&example_voronoi::dampening>(this))
      .connect_input(
        {"Cursor", "Dragging"},
        make_callable_ref<&example_voronoi::dragging>(this))
      .connect_input(
        {"View", "Zoom"}, make_callable_ref<&example_voronoi::zoom>(this))
      .connect_input(
        {"View", "PanX"}, make_callable_ref<&example_voronoi::pan_x>(this))
      .connect_input(
        {"View", "PanY"}, make_callable_ref<&example_voronoi::pan_y>(this))
      .map_inputs()
      .map_key({"Motion", "Dampening"}, {"LeftCtrl"}, input_setup().trigger())
      .map_cursor_pressure({"Cursor", "Dragging"})
...
public:
    ...
    auto launch(execution_context& ec, const launch_options&)
      -> unique_holder<application> final {
        return launch_with_video<example_voronoi>(ec);
    }
};
//------------------------------------------------------------------------------
