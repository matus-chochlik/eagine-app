...
///
export module eagine.app:old_resource_manager;
...
private:
    ...
    template <typename R>
    struct _adjust_res<old_managed_resource<R>>
      : std::type_identity<loaded_resource<R>> {};
...
public:
    ...
    auto connect(
      callable_ref<
        ...
        handler) noexcept -> old_managed_resource& {
    ...
    auto connect_to(C* obj) noexcept -> old_managed_resource& {
...
export using managed_plain_text = old_managed_resource<std::string>;
/// @brief Alias for managed text string list resource.
export using managed_string_list =
  old_managed_resource<std::vector<std::string>>;
/// @brief Alias for managed URL list resource.
export using managed_url_list = old_managed_resource<std::vector<url>>;
/// @brief Alias for managed floating-point number resource.
export using managed_float_vector = old_managed_resource<std::vector<float>>;
/// @brief Alias for managed floating-point number 3d vector resource.
export using managed_vec3_vector =
  old_managed_resource<std::vector<math::vector<float, 3>>>;
/// @brief Alias for managed curve of 3d vectors resource.
export using managed_smooth_vec3_curve =
  old_managed_resource<math::bezier_curves<math::vector<float, 3>, float, 3>>;
/// @brief Alias for managed curve of 4x4 matrices resource.
export using managed_mat4_vector =
  old_managed_resource<std::vector<math::matrix<float, 4, 4, true>>>;
/// @brief Alias for managed value tree resource.
export using managed_value_tree = old_managed_resource<valtree::compound>;
/// @brief Alias for managed GL geometry and attribute bindings resource.
export using managed_gl_geometry_and_bindings =
  old_managed_resource<gl_geometry_and_bindings>;
/// @brief Alias for managed GL shader include resource.
export using managed_gl_shader_include =
  old_managed_resource<oglplus::shader_include>;
/// @brief Alias for managed GL shader resource.
export using managed_gl_shader =
  old_managed_resource<oglplus::owned_shader_name>;
/// @brief Alias for managed GL GPU program resource.
export using managed_gl_program =
  old_managed_resource<oglplus::owned_program_name>;
/// @brief Alias for managed GL texture resource.
export using managed_gl_texture =
  old_managed_resource<oglplus::owned_texture_name>;
/// @brief Alias for managed GL buffer resource.
export using managed_gl_buffer =
  old_managed_resource<oglplus::owned_buffer_name>;
//------------------------------------------------------------------------------
/// @brief Template for the default resource manager instantiations.
/// @see old_resource_manager
/// @see old_managed_resource
export template <typename... Resources>
...
/// @see old_managed_resource
export using old_resource_manager = default_resource_manager<>;
//------------------------------------------------------------------------------
} // namespace eagine::app
