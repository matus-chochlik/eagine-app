...
//  Wrapper
//------------------------------------------------------------------------------
auto sky_viewer_background::set_skybox_unit(
  video_context& video,
  oglplus::texture_unit tu) -> sky_viewer_background& {
    assert(_impl);
...
//  Default Background
//------------------------------------------------------------------------------
class sky_viewer_default_background : public sky_viewer_background_intf {
public:
    sky_viewer_default_background(execution_context&, video_context&);
...
//------------------------------------------------------------------------------
sky_viewer_default_background::sky_viewer_default_background(
  execution_context&,
  video_context& video)
  : _bg{
      video,
      ...
      1.F} {}
//------------------------------------------------------------------------------
auto sky_viewer_default_background::is_loaded() noexcept -> bool {
    return true;
}
//------------------------------------------------------------------------------
void sky_viewer_default_background::load_if_needed(
  ...
  video_context&) {}
//------------------------------------------------------------------------------
void sky_viewer_default_background::request_update(
  const url&,
  execution_context&,
  video_context&) {}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void sky_viewer_default_background::set_skybox_unit(
  video_context&,
...
//------------------------------------------------------------------------------
auto sky_viewer_default_background::settings_height() -> float {
    return _selected_custom_color() ? 25.F + 45.F : 25.F;
}
//------------------------------------------------------------------------------
void sky_viewer_default_background::settings(
...
//  Skybox Background
//------------------------------------------------------------------------------
class sky_viewer_skybox_background : public sky_viewer_background_intf {
public:
    sky_viewer_skybox_background(execution_context&, video_context&);
...
//------------------------------------------------------------------------------
sky_viewer_skybox_background::sky_viewer_skybox_background(
  execution_context&,
  video_context& video)
  : _bg{video, 0} {}
//------------------------------------------------------------------------------
auto sky_viewer_skybox_background::is_loaded() noexcept -> bool {
    return true;
}
//------------------------------------------------------------------------------
void sky_viewer_skybox_background::load_if_needed(
  ...
  video_context&) {}
//------------------------------------------------------------------------------
void sky_viewer_skybox_background::request_update(
  const url&,
  execution_context&,
  video_context&) {}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void sky_viewer_skybox_background::set_skybox_unit(
  video_context& video,
...
//------------------------------------------------------------------------------
auto sky_viewer_skybox_background::settings_height() -> float {
    return 25.F;
}
//------------------------------------------------------------------------------
void sky_viewer_skybox_background::settings(const guiplus::imgui_api&) noexcept {
    //
}
//------------------------------------------------------------------------------
//  Make background
...
auto make_viewer_resource(
  ...
  video_context& video) -> sky_viewer_background_holder {
    if(locator.has_scheme("eagibg")) {
        if(locator.has_path("/Skybox")) {
            return {hold<sky_viewer_skybox_background>, ctx, video};
        }
        return {hold<sky_viewer_default_background>, ctx, video};
    }
    return {};
}
//------------------------------------------------------------------------------
